...
import { CasparCGConnection } from './lib/CasparCGConnection'
import { CasparCGProtocols } from './lib/CasparCGProtocols'
 ...
 */
export class CasparCG extends EventEmitter implements CasparCGConnection, ConnectionOptions, CasparCGProtocols.v2_1.AMCP {
	/**
  ...
  * con.connect();
	 ...
	 *
	 * @param options	Setting new [[CasparCGConnection]] properties will override each individual property allready defined on the `CasparCG` object. Existing properties not overwritten by this `options` object will remain.
	 */
