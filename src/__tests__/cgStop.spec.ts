...
describe('Test the CGSTOP command', () => {
	...
	test('Check CGSTOP v218', async () => {
		version('218')
		let reqPromise = conn.cgStop({ channel: 1, layer: 1, flashLayer: 1 })
