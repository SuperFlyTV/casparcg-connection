...
describe('Test the RESUME command', () => {
	...
	test('Check RESUME v218', async () => {
		version('218')
		let reqPromise = conn.resume({ channel: 1, layer: 1 })
