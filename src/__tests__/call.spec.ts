...
describe('Test the CALL command', () => {
	...
	test('Check CALL v218', async () => {
		version('218')
		let reqPromise = conn.call({ channel: 1, layer: 1})
