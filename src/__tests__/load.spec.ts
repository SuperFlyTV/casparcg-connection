...
describe('Test the LOAD command', () => {
	...
	test('Check LOAD v218', async () => {
		version('218')
		let reqPromise = conn.load({ channel: 1, layer: 1, source: { clip: 'AMB' }})
