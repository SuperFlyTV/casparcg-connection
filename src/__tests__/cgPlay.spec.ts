...
describe('Test the CGPLAY command', () => {
	...
	test('Check CGPLAY v218', async () => {
		version('218')
		let reqPromise = conn.cgPlay({ channel: 1, layer: 1, flashLayer: 1 })
