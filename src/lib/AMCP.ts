...
export class LogCategoryCommand extends AbstractCommand {
	...
	paramProtocol = [
		new ParamSignature(Optional, 'calltrace', Enum.LogCategory.CALLTRACE, new ParameterValidator.BooleanValidatorWithDefaults(1, 0)),
		new ParamSignature(Optional, 'communication', Enum.LogCategory.COMMUNICATION, new ParameterValidator.BooleanValidatorWithDefaults(1, 0))
	]
}
