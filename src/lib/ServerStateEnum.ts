...
export namespace Enum {
	...
	export class Ease extends AbstractEnum {
		...
		private static EASELINEAR = Ease.LINEAR;
		static NONE = new Ease("EASENONE");
		private static EASENONE = Ease.NONE;
		static IN_QUAD = new Ease("EASEINQUAD");
		private static EASEINQUAD = Ease.IN_QUAD;
		static OUT_QUAD = new Ease("EASEOUTQUAD");
		private static EASEOUTQUAD = Ease.OUT_QUAD;
		static IN_OUT_QUAD = new Ease("EASEINOUTQUAD");
		private static EASEINOUTQUAD = Ease.IN_OUT_QUAD;
		static OUT_IN_QUAD = new Ease("EASEOUTINQUAD");
		private static EASEOUTINQUAD = Ease.OUT_IN_QUAD;
		static IN_CUBIC = new Ease("EASEINCUBIC");
		private static EASEINCUBIC = Ease.IN_CUBIC;
		static OUT_CUBIC = new Ease("EASEOUTCUBIC");
		private static EASEOUTCUBIC = Ease.OUT_CUBIC;
		static IN_OUT_CUBIC = new Ease("EASEINOUTCUBIC");
		private static EASEINOUTCUBIC = Ease.IN_OUT_CUBIC;
		static OUT_IN_CUBIC = new Ease("EASEOUTINCUBIC");
		private static EASEOUTINCUBIC = Ease.OUT_IN_CUBIC;
		static IN_QUART = new Ease("EASEINQUART");
		private static EASEINQUART = Ease.IN_QUART;
		static OUT_QUART = new Ease("EASEOUTQUART");
		private static EASEOUTQUART = Ease.OUT_QUART;
		static IN_OUT_QUART = new Ease("EASEINOUTQUART");
		private static EASEINOUTQUART = Ease.IN_OUT_QUART;
		static OUT_IN_QUART = new Ease("EASEOUTINQUART");
		private static EASEOUTINQUART = Ease.OUT_IN_QUART;
		static IN_QUINT = new Ease("EASEINQUINT");
		private static EASEINQUINT = Ease.IN_QUINT;
		static OUT_QUINT = new Ease("EASEOUTQUINT");
		private static EASEOUTQUINT = Ease.OUT_QUINT;
		static IN_OUT_QUINT = new Ease("EASEINOUTQUINT");
		private static EASEINOUTQUINT = Ease.IN_OUT_QUINT;
		static OUT_IN_QUINT = new Ease("EASEOUTINQUINT");
		private static EASEOUTINQUINT = Ease.OUT_IN_QUINT;
		static IN_SINE = new Ease("EASEINSINE");
		private static EASEINSINE = Ease.IN_SINE;
		static OUT_SINE = new Ease("EASEOUTSINE");
		private static EASEOUTSINE = Ease.OUT_SINE;
		static IN_OUT_SINE = new Ease("EASEINOUTSINE");
		private static EASEINOUTSINE = Ease.IN_OUT_SINE;
		static OUT_IN_SINE = new Ease("EASEOUTINSINE");
		private static EASEOUTINSINE = Ease.OUT_IN_SINE;
		static IN_EXPO = new Ease("EASEINEXPO");
		private static EASEINEXPO = Ease.IN_EXPO;
		static OUT_EXPO = new Ease("EASEOUTEXPO");
		private static EASEOUTEXPO = Ease.OUT_EXPO;
		static IN_OUT_EXPO = new Ease("EASEINOUTEXPO");
		private static EASEINOUTEXPO = Ease.IN_OUT_EXPO;
		static OUT_IN_EXPO = new Ease("EASEOUTINEXPO");
		private static EASEOUTINEXPO = Ease.OUT_IN_EXPO;
		static IN_CIRC = new Ease("EASEINCIRC");
		private static EASEINCIRC = Ease.IN_CIRC;
		static OUT_CIRC = new Ease("EASEOUTCIRC");
		private static EASEOUTCIRC = Ease.OUT_CIRC;
		static IN_OUT_CIRC = new Ease("EASEINOUTCIRC");
		private static EASEINOUTCIRC = Ease.IN_OUT_CIRC;
		static OUT_IN_CIRC = new Ease("EASEOUTINCIRC");
		private static EASEOUTINCIRC = Ease.OUT_IN_CIRC;
		static IN_ELASTIC = new Ease("EASEINELASTIC");
		private static EASEINELASTIC = Ease.IN_ELASTIC;
		static OUT_ELASTIC = new Ease("EASEOUTELASTIC");
		private static EASEOUTELASTIC = Ease.OUT_ELASTIC;
		static IN_OUT_ELASTIC = new Ease("EASEINOUTELASTIC");
		private static EASEINOUTELASTIC = Ease.IN_OUT_ELASTIC;
		static OUT_IN_ELASTIC = new Ease("EASEOUTINELASTIC");
		private static EASEOUTINELASTIC = Ease.OUT_IN_ELASTIC;
		static IN_BACK = new Ease("EASEINBACK");
		private static EASEINBACK = Ease.IN_BACK;
		static OUT_BACK = new Ease("EASEOUTBACK");
		private static EASEOUTBACK = Ease.OUT_BACK;
		static IN_OUT_BACK = new Ease("EASEINOUTBACK");
		private static EASEINOUTBACK = Ease.IN_OUT_BACK;
		static OUT_IN_BACK = new Ease("EASEOUTINTBACK");
		private static EASEOUTINBACK = Ease.OUT_IN_BACK;
		static OUT_BOUNCE = new Ease("EASEOUTBOUNCE");
		private static EASEOUTBOUNCE = Ease.OUT_BOUNCE;
		static IN_BOUNCE = new Ease("EASEINBOUNCE");
		private static EASEINBOUNCE = Ease.IN_BOUNCE;
		static IN_OUT_BOUNCE = new Ease("EASEINOUTBOUNCE");
		private static EASEINOUTBOUNCE = Ease.IN_OUT_BOUNCE;
		static OUT_IN_BOUNCE = new Ease("EASEOUTINBOUNCE");
		private static EASEOUTINBOUNCE = Ease.OUT_IN_BOUNCE;
	}
}